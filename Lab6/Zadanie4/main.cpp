...
void processMenu(int option) {
	...
	case 8:
		...
		break;
	case 9:
		Settings::getInstance().directional = true;
		break;
	case 10:
		Settings::getInstance().directional = false;
		break;
...
void createMenu() {
	...
	int lightTypeMenu = glutCreateMenu(processMenu);
	glutAddMenuEntry("Directional", 9);
	...
	glutAddSubMenu("Type", lightTypeMenu);
