...
void DisplayScene()
{
	...
	glUniform1i(glGetUniformLocation(idProgram, "mask"), 2);
...
void Initialize()
{
	...
	// wczytywanie pliku graficznego
	tex_data2 = stbi_load("galaxy.jpg", &tex_width2, &tex_height2, &tex_n2, 0);
	if (tex_data2 == NULL) {
		printf("Image can�t be loaded!\n");
	}
	...
	glBindTexture(GL_TEXTURE_2D, idTexture2);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, tex_width2, tex_height2, 0, GL_RGB, GL_UNSIGNED_BYTE, tex_data2);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	...
	// wczytywanie pliku graficznego
	tex_data3 = stbi_load("mask.png", &tex_width3, &tex_height3, &tex_n3, 0);
	if (tex_data3 == NULL) {
		printf("Image can�t be loaded!\n");
	}
	...
	glBindTexture(GL_TEXTURE_2D, idTexture3);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, tex_width3, tex_height3, 0, GL_RGB, GL_UNSIGNED_BYTE, tex_data3);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
