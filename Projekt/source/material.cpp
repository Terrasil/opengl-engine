...
void Material::setRefraction(float newRefraction) {
...
void Material::setRefractionCoefficient(float newRefractionCoefficient) {
	refractionCoefficient = newRefractionCoefficient;
}
...
void Material::setReflection(float newReflection) {
